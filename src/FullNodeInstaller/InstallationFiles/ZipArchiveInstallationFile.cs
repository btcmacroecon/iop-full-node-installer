...
{
  public class ZipArchiveInstallationFile: DownloadableInstallationFile
  {
    /// <summary>Class logger.</summary>
    private static Logger log = LogManager.GetLogger("FullNodeInstaller.ZipArchiveInstallationFile");
    ...
    public ZipArchiveInstallationFile(string Name, string Uri, string UnpackDirectoryName, bool CanUninstall = true, string SavePathAs = null, string InternalPath = null) :
    ...
    public override bool Install()
    {
      ...
      if (DownloadFileToTemp(uri))
      {
        ...
        try
        {
          ZipFile.ExtractToDirectory(downloadedFileName, unpackDirectoryName);
